...
import 'package:cup_coffe_case/ui/widgets/address_cart.dart';
import 'package:cup_coffe_case/ui/widgets/coffe_order_card.dart';
import 'package:cup_coffe_case/ui/widgets/order_summary_card.dart';
    ...
    return Scaffold(
      ...
      body: Column(
          children: [
            ...
            CoffeOrderCard(product: widget.product),

            const SizedBox(height: 40,),
            
            OrderSummaryCard(product: widget.product),
